...
class MyMessage_Base : public ::omnetpp::cPacket
{
  ...
  public:
    ...
    virtual int getHeaderSeq_num() const;
    virtual void setHeaderSeq_num(int HeaderSeq_num);
    virtual const char * getPayload() const;
    virtual void setPayload(const char * Payload);
    virtual char getTrailer_parity() const;
    virtual void setTrailer_parity(char Trailer_parity);
